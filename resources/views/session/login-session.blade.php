          ...
          <div class="row">
            <div class="d-none d-md-block">
              <div class="row mt-4">
                      ...
                      <form role="form" method="POST" action="/session">
                        ...
                        <label>Email</label>
                          ...
                          <div class="text-center">
                            <button type="submit" class="btn bg-danger w-100 mt-4 mb-0">Sign in</button>
                          </div>
                      </form>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <img src="../asset/img/mugiwara.png" width="100%" />
                </div>
              </div>
            </div>
                          ...
                          <label>Email</label>
                            ...
                            <label for="basic-url" class="form-label">Password</label>
                              <div class="input-group mb-3">                               
                                ...
                                <button class="input-group-text btn btn-outline-transparent" type="button" id="button-addon2"><i class="far fa-eye-slash" id="togglePassword"   onclick="myFunction1()"></i></button>
                              </div>
