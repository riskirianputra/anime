...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="../assets/img/mugiwara.png"  alt="..." width="500px" >
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Laravel Examples</h6>
            ...
            <li class="nav-item pb-2">
              <a class="nav-link {{ (Request::is('anime') ? 'active' : '') }}" href="{{ url('anime') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i style="font-size: 1rem;" class="fas fa-tv fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('anime') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                  </div>  
            ...
            <li class="nav-item pb-2">
              <a class="nav-link {{ (Request::is('genre') ? 'active' : '') }}" href="{{ url('genre') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i style="font-size: 1rem;" class="fas fa-tv fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('genre') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                  </div>  
            ...
            <li class="nav-item pb-2">
              <a class="nav-link {{ (Request::is('abjad') ? 'active' : '') }}" href="{{ url('abjad') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i style="font-size: 1rem;" class="fas fa-tv fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('abjad') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                  </div>  
                  <span class="nav-link-text ms-1">Abjad</span>
              </a>
            </li>
            ...
            <li class="nav-item pb-2">
              <a class="nav-link {{ (Request::is('type') ? 'active' : '') }}" href="{{ url('type') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i style="font-size: 1rem;" class="fas fa-tv fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('type') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                  </div>  
            ...
            <li class="nav-item pb-2">
              <a class="nav-link {{ (Request::is('episode') ? 'active' : '') }}" href="{{ url('episode') }}">
                  <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i style="font-size: 1rem;" class="fas fa-tv fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('episode') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                  </div>  
                  <span class="nav-link-text ms-1">Episode</span>
              </a>
            </li>
